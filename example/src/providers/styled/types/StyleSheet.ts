...
export type AnyProp<T> = T | string | string[] | number;

export type ExtendedStyle<T extends Record<any, any>> = AnyProp<T> &
  {
    [key in CustomClasses]: AnyProp<T>;
  } & {
    [key: string]: AnyProp<T>;
  } & {
